...
import { DidJwk, BearerDid, Did } from '@web5/dids';
...
const aliceBearerDid: BearerDid = await DidJwk.create();
...
app.get('/protocols', async (req: Request, res: Response) => {
...
app.get('/offerings', async (req: Request, res: Response) => {
  const pd = {
...
app.post('/exchanges', async (req: Request, res: Response) => {
  res.send(`Coming soon....`);
});


app.post('/exchanges/:id', async (req: Request, res: Response) => {
  res.send(`Coming soon....`);
});
...
app.get('/exchanges/:id', async (req: Request, res: Response) => {
  res.send('Coming soon....');
});
